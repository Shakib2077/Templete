			...
			<form id="myForm" method="POST" action="{{ route('update.permission') }}" class="forms-sample">
				...
				<div class="mb-3">
					...
					<select name="group_name" class="form-select" id="exampleFormControlSelect1">
                        ...
                        <option value="aminities" {{ $permission->group_name == 'aminities' ? 'selected' : ''}}>Aminities</option>
                        ...
                        <option value="buy" {{ $permission->group_name == 'buy' ? 'selected' : ''}}>Testimonial</option>
